...
class ScientificCalc:
    ...
    def x_power_y(cls, base_val, power_val):
        ...
        if power_val == 0:
            ...
            return cls.x_power_y(base_val, int(power_val / 2)) * cls.x_power_y(base_val, int(power_val / 2))
        else:
            if power_val > 0:
                return base_val * cls.x_power_y(base_val, int(power_val / 2)) * cls.x_power_y(base_val, int(power_val / 2))
            else:
