...
"""
    ...
    >>> m = Map([
    ...     # Static URLs
    ...     Rule('/', endpoint=ttemplateses),
    ...     Rule('/about', endpoint=templatemplates    ...     Rule('/help', endpoint=templates),templates..     # Knowledge Base
    ...     Subdomain('kb', [
    ...
    >>> c.build("static/about")templates/about'
    >>> c.build("static/index",templates_external=True)
    'http://www.example.com/'

    >>> c = m.bind('example.com', subdomain='kb')
    >>> c.build("static/about")templateshttp://www.example.com/about'
    ...
    >>> c = m.bind('example.com')
    >>> c.match("/")
    ('static/index',templates   >>> c.match("/about")
    ('static/about',templates   >>> c = m.bind('example.com', '/', 'kb')
    >>> c.match("/")
    ('kb/index', {})
...
_rule_re = re.compile(
    r"""
    (?P<static>[^<]*) templates                    # static rule datemplates <
    (?:
...
def parse_rule(rule):
    ...
    `None` it's a static url partemplateserwise it's a dynamic one.
    ...
    while pos < end:
        ...
        data = m.groupdict()
        if data["static"]:
    templates  yield None, None, data["static"]
     templatesiable = data["variable"]
...
templatesedirect_to`
    ...
    def match_compare_key(self):
        ...
        2.  rules with more static parts ctemplatesrst so the second argument
            is the negative length of the number of the static weightstemplates    3.  we order by static weightstemplatesh is a combination of index
            and length
